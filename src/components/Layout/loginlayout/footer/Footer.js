            ...
            <div className="hidden md:flex justify-center items-center mx-auto pt-2">
                <div className="flex flex-row justify-center items-center space-x-28">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="transition-transform duration-300 hover:scale-105 rounded-sm mx-auto my-auto 
                ...
                flex items-center justify-center">
                            <Link className="text-xl font-extrabold text-white" to="/register">Đăng Ký</Link>
                        </div>
