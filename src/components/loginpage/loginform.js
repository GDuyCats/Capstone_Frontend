...
function Loginform() {
  ...
  return (
    <div class="bg-white absolute inset-0 flex w-[700px] h-[400px] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
        ...
        <div class="bg-white p-4 rounded-lg mt-5 ml-10">
          <div class="relative bg-inherit">
            <input
              ...
              id="username"
              name="username"
              class="peer bg-transparent w-[300px] h-[40px] rounded-lg text-gray-200 placeholder-transparent ring-2 px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-rose-600"
        ...
        <div class="flex ml-14 mt-5 space-x-20">
          ...
          <section>
            <label class="inline-flex items-center" for="grayCheckBox">
              ...
              />
              <span class="ml-2 text-gray-500 hover:cursor-pointer hover:brightness-110">
                Ghi nhớ tôi
              </span>
            </label>
          </section>
          {/*Forget password*/}
          <section>
            <span class="text-gray-500  ml-2 hover:cursor-pointer hover:brightness-110 hover:underline">
              Quên mật khẩu
            </span>
          </section>
        </div>
      ...
      {/*Facebook*/}
      <div class="pr-6 mt-8">
        <label class="text-blue-400 text-xs font-bold block mb-2">
