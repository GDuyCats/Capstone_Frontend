        ...
        <div class='bg-white absolute inset-0 flex w-[700px] h-[400px] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2'>
            <div>
                ...
                <div class='flex ml-14 mt-5 space-x-20'>
                    ...
                    {/*Forget password*/}
                    <section >
                        <span class='text-gray-500  ml-2 hover:cursor-pointer hover:brightness-110'>Quên mật khẩu</span>
                    </section>
                </div>
                {/*Đăng nhập*/}
            ...
            {/*Facebook*/}
            <div class='pr-6 mt-5'>
                <label class='text-blue-400 text-xs font-bold block'>HOẶC ĐĂNG NHẬP BẰNG NỀN TẢNG KHÁC</label>
                <Otherlogin />
            </div>
        </div>
    )
